	...
	if($_POST['action']=='form'){ //check if form was submitted
		if ( ($_POST['buy'] == 0 or $_POST['buy'] == 1) and ($_POST['top'] == 0 or $_POST['top'] == 1)){
			...
			if($_POST['after'] == 0 ){
				...
				$sql = "INSERT INTO `orders`(`id_create`,`percentage`,`symbol`,`buy`, `top`, `price`,`pricedelta`, `delta`, `comment`,`status`, `after`, `gafter`) VALUES ('".$lastidid."','".$_POST['qty']."','$symbol','".$_POST['buy']."','".$_POST['top']."','".$_POST['price']."','".$_POST['pricedelta']."','".$_POST['delta']."','".$_POST['comment']."','-1','".$_POST['after']."','".$_POST['gafter']."')";
				$conn->query($sql);
			}
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Insert Order2   |   last Price =  <?php echo $lastPrice; ?></h5>
              </div>
              <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?symbol=".$symbol;?>" method="post">
				<div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Symbol</label>
                        <input type="text" name="symbol" class="form-control" disabled="" placeholder="Company" value="<?php echo $symbol; ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>price</label>
                        <input type="number" step="0.00000000001" name="price" class="form-control" placeholder="" required>
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>delta</label>
                        <input type="number" step="0.00000000001" name="delta" class="form-control" value="0" required>
                      </div>
                    </div>
                  </div>
				  <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.00000000001" name="pricedelta" class="form-control" value="0">
                      </div>
                    </div>
				  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.00000000001" name="qty" class="form-control" placeholder="--%" value="100" required>
                      </div>
                    </div>
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.00000000001" name="pricet" class="form-control" placeholder=""  value="0" required>
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>OR delta of price</label>
                        <input type="number" step="0.00000000001" name="deltaOfPricet" class="form-control" value="0" required>
                      </div>
                    </div>
                  </div>
				                    <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.00000000001" name="priced" class="form-control" placeholder=""  value="0" required>
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>OR delta of price</label>
                        <input type="number" step="0.00000000001" name="deltaOfPriced" class="form-control" value="0" required>
                      </div>
                    </div>
                  </div>
				  <div class="row">
                    ...
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="number"  step="0.00000000001" name="delta" class="form-control" placeholder="<?php echo $lastidorder; ?>" value="0" required>
                      </div>
                    </div>
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
				...
				<div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>price</label>
                        <input type="number" step="0.00000000001" name="price" class="form-control" placeholder="" value="<?php echo $findResult['price']; ?>" required>
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>delta</label>
                        <input type="number" step="0.00000000001" name="delta" class="form-control" value="<?php echo $findResult['delta']; ?>" required>
                      </div>
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        <label>Quantity %</label>
                        <input type="number" step="0.00000000001" name="qty" class="form-control" placeholder="--%" value="<?php echo $findResult['percentage']; ?>" required>
                      </div>
                    </div>
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
				...
				<div class="card-body">
				  ...
				  <div class="row">
                    ...
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        <label>delta for profit</label>
                        <input type="number" step="0.00000000001" name="delta2" class="form-control" placeholder="<?php echo $lastidorder; ?>" value="0" required>
                      </div>
                    </div>
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
